...
use \Jsilva\Model\Address;
use \Jsilva\Model\User;
use \Jsilva\Model\Order;
use \Jsilva\Model\OrderStatus;
...
$app->get("/profile", function() {
    ...
    //false força logar como usuário e não como admin
    User::verifyLogin(false);
...
$app->post("/profile", function() {
    ...
    User::setSuccess("Dadoa alterados com suscesso");
...
$app->get("/boleto/:idorder", function($idorder) {
    ...
    $dadosboleto["demonstrativo1"] = "Pagamento de Compra na Loja Jsilva E-commerce";
    ...
    // SEUS DADOS
    $dadosboleto["identificacao"] = "Jsilva";
    $dadosboleto["cpf_cnpj"] = "24.700.731/0001-08";
    $dadosboleto["endereco"] = "Rua Ademar Saraiva Leão, 234 - Alvarenga, 09853-120";
    $dadosboleto["cidade_uf"] = "São Bernardo do Campo - SP";
    $dadosboleto["cedente"] = "Jsilva";
